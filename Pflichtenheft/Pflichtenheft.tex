...
Im Falle des \textbf{Parametereditors} handelt es sich um ein komplettes Projekt. Genauer gesagt also den C-Code, die Parameter und die Eigenschaften für Wahlverfahren inklusive der kompletten Eigenschaften-Liste. Der Kürzel für den Parametereditor lautet \textbf{P}. \\
...
Es kann nach Eingabe von Wahlverfahren und Eigenschaften geprüft werden ob das Wahlverfahren die formalen Eigenschaften erfüllt. Voraussetzung dafür sind ein syntaktisch fehlerfreies Wahlverfahren und syntaktisch fehlerfreie formale Eigenschaften. Vor dem Prüfen kann der Nutzer Testparameter angeben (Anzahl von Kandidaten, Wählern, Sitzen und einem Timeout, dass dem Prüfen eine zeitliche Obergrenze gibt). Diese können auch gespeichert werden.\\
