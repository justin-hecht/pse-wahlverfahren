...
Ziel des implementierten Programmes ist es, eine Lösung zur Analyse von formalen Eigenschaften von Wahlverfahren zu präsentieren. Zur Analyse der Eigenschaften wird CBMC (Glossareintrag) verwendet. Das Programm soll folgende Module bereitstellen: 
\begin{itemize}
