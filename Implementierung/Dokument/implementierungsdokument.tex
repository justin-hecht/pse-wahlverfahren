...
\section{Codearea}
- Die Klasse JTextPaneToolbox wurde hinzugefügt. Diese implementiert oft benötigte Funktionalität fpr JTextPanes an.\\
...
- NewlineInserter ist nun ein eigenes package. BetweenCurlyBracesNewlineInserter verwendet nun StandardNewlineInserter.\\
...
Die Klasse ParameterEditor implementiert jetzt nicht mehr BEASTCommunicator aus \verb!highlevel!. Damit wird ParameterEditor klar von der Kommunikation zwischen den einzelnen Teilen von BEAST getrennt. \\
\\
...
- RepainThread: Implementiert Runnable. Bekommt einen JFrame für welchen er 60 Mal die Sekunde die repaint-Funktion aufruft. Dies ist benötigt da die Frames auf Windows sonst nicht korrekt rendern falls zuvor ein anderes Fenster vor ihnen war.\\
...
- ActionIdAndListener: Eine einfache Wrapper-Klasse welche zugriff auf einen ActionListener und dazugehörige String-Id bietet.\\
